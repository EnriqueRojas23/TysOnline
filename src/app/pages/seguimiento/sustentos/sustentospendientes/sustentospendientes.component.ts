...
@Component({
  selector: 'app-sustentospendientes',
  templateUrl: './sustentospendientes.component.html',
  styleUrls: ['./sustentospendientes.component.scss'],
...
export class SustentospendientesComponent implements OnInit {
  ...
  editar(id) {
    ...
    this.router.navigate(['/sustentos/sustentarhr', id]);
