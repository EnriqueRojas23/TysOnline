...
@Component({
  selector: 'app-listadorepartidores',
  templateUrl: './listadorepartidores.component.html',
  styleUrls: ['./listadorepartidores.component.scss']
})
export class ListadorepartidoresComponent implements OnInit {
  ...
  tarifario(id) {
    this.router.navigate(['proveedor/listadotarifarepartidor',id ]);
  }
