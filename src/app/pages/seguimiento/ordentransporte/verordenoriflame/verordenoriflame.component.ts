...
@Component({
  selector: 'app-verordenoriflame',
  templateUrl: './verordenoriflame.component.html',
  styleUrls: ['./verordenoriflame.component.scss']
})
export class VerordenoriflameComponent implements OnInit {
  id: any;
