...
export class LiquidarManifiestoComponent implements OnInit {
    ...
    evento() {
      this.ordenTransporteService.liquidarManifiesto(this.id
        , this.model.maestroincidenciaid
        , this.model.observacion).subscribe(list => {
          this.ref.close();
      });
    }
