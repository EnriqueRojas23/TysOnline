...
<div class=" mb-3 col-md-12">
     ...
     <!-- <p-dropdown name="manifiestos"
                      [options]="manifiestos" [(ngModel)]="model.idmanifiesto"
                      scrollHeight="30vh"  class="input-form-field"
...
export class AgregarOThrModalComponent  implements OnInit {
    ...
    ngOnInit() {
      ...
      this.ordenService.getAllOrderTransportPending(this.model).subscribe(resp => {
         this.ordenes11 = resp;
      });

      this.model.idestado = 1;
      this.ordenService.getAllPreHojaRuta(this.model).subscribe(list =>  {
    ...
    cargarManifiestos(hojaruta: any) {
      ...
      this.ordenService.getAllPreManifiestos(this.model).subscribe(list =>  {
