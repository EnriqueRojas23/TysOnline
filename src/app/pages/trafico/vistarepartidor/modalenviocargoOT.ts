...
<div class="col-md-12">
                ...
                <div class="row  mt-3">
                <div class="col-md-6">
                    <button   class='btn-danger btn ' pButton iconPos="left" label="Confirmar Envío"   (click)="entregarOT()"  type="button"></button>
                    </div>
                </div>
...
export class EnvioCargoModalComponent  implements OnInit {
    ...
    entregarOT(){
      ...
      // }
          ...
          this.ordenService.confirmar_enviocargo(this.model).subscribe(resp => {
